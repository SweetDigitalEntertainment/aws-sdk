...
namespace Amazon.Extensions.CognitoAuthentication
{
    public partial class CognitoUser
    {
        ...
        /// </summary>
        public void ForgotPasswordAsync(AsyncCallback callback = null)
        {
            ForgotPasswordRequest forgotPassRequest = CreateForgotPasswordRequest();

            Provider.ForgotPasswordAsync(forgotPassRequest, r => callback?.Invoke(new AsyncResult(r.Exception)));
        }
        ...
        public void ChangePasswordAsync(string oldPass, string newPass, AsyncCallback callback = null)
        {
            ChangePasswordRequest changePassRequest = CreateChangePasswordRequest(oldPass, newPass);

            Provider.ChangePasswordAsync(changePassRequest, r => callback?.Invoke(new AsyncResult(r.Exception)));
        }
        ...
        /// </summary>
        public void GlobalSignOutAsync(AsyncCallback callback = null)
        {
            EnsureUserAuthenticated();
            ...
            SessionTokens = null;
            Provider.GlobalSignOutAsync(globalSignOutRequest, r => callback?.Invoke(new AsyncResult(r.Exception)));
        }

        /// <summary>
        /// Deletes the current user using an asynchronous call
        /// </summary>
        public void DeleteUserAsync(AsyncCallback callback = null)
        {
            EnsureUserAuthenticated();
            ...
            Provider.DeleteUserAsync(deleteUserRequest, r => callback?.Invoke(new AsyncResult(r.Exception)));
        }
