...
namespace Amazon.Extensions.CognitoAuthentication
{
    public partial class CognitoDevice
    {
        ...
        /// </summary>
        public void GetDeviceAsync(AsyncCallback callback = null)
        {
            GetDeviceRequest getDeviceRequest = CreateGetDeviceRequest();

            User.Provider.GetDeviceAsync(getDeviceRequest, r =>
            {
                if (r.Exception == null)
                {
                    UpdateThisDevice(r.Response.Device);
                }
        ...
        /// </summary>
        public void RememberThisDeviceAsync(AsyncCallback callback = null)
        {
